      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 p-4">
          ...
          <div className="space-y-2">
            ...
            <button className="w-full flex items-center justify-between p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              ...
              <span className="text-xs text-[oklch(0.4_0.15_140)] font-semibold">
                Daftar
              </span>
            </button>
            ...
            <div className="pt-2 border-t border-gray-100">
              ...
              <div className="space-y-1">
                ...
                <button className="w-full flex items-center justify-between text-xs py-1 hover:text-[oklch(0.4_0.15_140)]">
                  ...
                  <span className="text-[oklch(0.4_0.15_140)] font-semibold">
                    Cek
                  </span>
                </button>
              </div>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <span className="text-xs text-gray-700">Pembelian</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-gray-700">Toko Favorit</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-gray-700">Pengaturan</span>
            </button>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          >
