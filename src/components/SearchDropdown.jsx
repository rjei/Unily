...
const SearchDropdown = ({ isLoading, results, onSelectItem, onViewAll }) => {
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg shadow-xl border border-gray-200 max-h-[500px] overflow-y-auto z-50">
      {isLoading ? (
        <LoadingSkeleton />
      ) : (
        <>
