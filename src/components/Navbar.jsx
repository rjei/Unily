  ...
  <nav className="bg-white p-4 shadow-md sticky top-0 z-20">
    <div className="container mx-auto flex items-center justify-between">
      <div className="flex items-center space-x-2">
        <img src="/logo.png" alt="Unily" className="h-16 w-16 object-contain" />
        <span className="text-2xl font-bold text-gray-800">Unily</span>
      </div>
      <div className="flex items-center space-x-6">
        <button className="text-gray-600 hover:text-[oklch(0.4_0.15_140)]">
          <Search size={22} />
        </button>
        ...
        {currentUser ? (
          <button
            ...
            className="bg-[oklch(0.4_0.15_140)] text-white px-4 py-2 rounded-full font-medium hover:bg-[oklch(0.35_0.15_140)] transition-colors flex items-center"
          >
